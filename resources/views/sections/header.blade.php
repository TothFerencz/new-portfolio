<header class="relative bg-white min-h-screen flex flex-col justify-center px-6 pt-24 pb-20">
    <div class="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">

        <!-- Bal oldal -->
        <div class="space-y-6 text-center lg:text-left">
            <!-- Badge -->
            <div class="inline-flex items-center justify-center bg-white border border-gray-200 px-4 py-1  text-sm">
            ...
            <div class="flex flex-col sm:flex-row sm:justify-center lg:justify-start gap-4">
                <a href="#"
                    class="px-6 py-3 rounded-full bg-gradient-to-b from-black to-gray-900 text-white text-sm  hover:opacity-90 transition">
                    Get Started
                </a>
                <a href="#"
                    class="px-6 py-3 rounded-full bg-gray-100 text-gray-700 text-sm  hover:bg-gray-200 transition">
                    Learn More
                </a>
            </div>
